...
<p><b>Rehab360</b> היא מערכת ווב לניהול תהליך שיקום דיגיטלי, עם שני תפקידי משתמש:</p>

<ul>
  <li><b>Patient</b> – צפייה בתוכנית טיפול, צפייה/דיווח על תרגילים ומשוב יומי.</li>
  <li><b>Physiotherapist</b> – דשבורד למעקב מטופלים, סטטוסים וניווט למסך פרטי מטופל.</li>
</ul>
...
**כתובת השרת (הגשה/הרצה):** `shanimi2.mtacloud.co.il`
